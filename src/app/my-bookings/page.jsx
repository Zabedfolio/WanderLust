...
const MyBookingPage = async () => {
    ...
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/booking/${user.id}`, {
            headers: {                               // ← was missing headers object
                authorization: `Bearer ${token}`    // ← capital B, inside headers
            }
        });
            ...
            <div className="max-w-4xl mx-auto">
                ...
                {data.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-24 bg-white shadow-sm">
                        ...
                        <a href="/destinations" className="px-8 py-3 bg-cyan-500 text-white font-bold text-sm hover:bg-cyan-600 transition-colors">
