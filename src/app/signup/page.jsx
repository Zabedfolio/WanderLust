...
export default function SignupPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setFormData({ name: "", email: "", image: "", password: "", confirmPassword: "" });
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-xl bg-white border border-slate-200 shadow-xl shadow-slate-200/50 p-8 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full border border-slate-200 bg-slate-50 px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-100 outline-none transition"
            />
          </div>
          ...
          {error && (
            <div className="bg-rose-50 border border-rose-100 px-4 py-3 text-sm text-rose-700">
              {error}
            </div>
          )}
          {success && (
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-cyan-600 px-4 py-3 text-white font-semibold shadow-lg shadow-cyan-500/20 transition hover:bg-cyan-700 disabled:cursor-not-allowed disabled:bg-slate-300"
          >
